...
readonly RC_LOOKAHEAD=32 # Les valeurs plus élevées consomment plus de mémoire GPU.
# readonly RC_LOOKAHEAD=64 Mode film
...
Options:
  ...
  -r, --random              Mode aléatoir : sélectionne N fichiers aléatoires (défaut: 10)
...
Exemples:
  ...
  ./conversion.sh --dry-run --random
  ./conversion.sh --random --limit 5
