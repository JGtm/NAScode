...
MSG_CFG_AVAILABLE_MODES="Modes disponibles : film, adaptatif, adaptatif-vmaf, gaming, serie"
MSG_CFG_TWOPASS_IGNORED_ADAPTIVE="Two-pass (-2) ignoré en mode %s : ce mode encode en CRF contraint single-pass (bitrate calculé par fichier/segment)."
...
MSG_HELP_ESSENTIAL="force le binaire SVT-AV1-Essential (encodage AV1)"
MSG_HELP_NO_ESSENTIAL="force le fallback libsvtav1 mainline"
...
MSG_HELP_MODE_ADAPTATIF_VMAF="auto-boost-lite par segment via VMAF prédictif (AV1, audio passthrough)"
MSG_HELP_MODE_GAMING="variante adaptatif calibrée high-motion (replays, captures jeux ; FPS quelconque)"
...
MSG_UI_FPS_LIMITED="FPS limité : %s → %s fps"
